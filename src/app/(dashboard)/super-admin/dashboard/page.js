// ==========================================
// FILE 9: src/app/(dashboard)/super-admin/dashboard/page.js
// ==========================================
"use client";
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="p-4 rounded-lg border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all text-left">
              ...
              <p className="font-medium text-gray-900 text-sm">Tambah User</p>
            </button>
            <button className="p-4 rounded-lg border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all text-left">
              <BookOpen
                size={24}
            ...
            <button className="p-4 rounded-lg border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all text-left">
              <GraduationCap
                ...
                style={{ color: "#00a3d4" }}
              />
              <p className="font-medium text-gray-900 text-sm">Kelola Kelas</p>
            </button>
            <button className="p-4 rounded-lg border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all text-left">
              <Calendar
                size={24}
                ...
                style={{ color: "#00a3d4" }}
              />
              <p className="font-medium text-gray-900 text-sm">Atur Jadwal</p>
            </button>
          </div>
        </div>
      </div>
